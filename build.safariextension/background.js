...
// Constants for tab data
var SET_CURRENT_TABID = exports.SET_CURRENT_TABID = 'SET_CURRENT_TABID';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bindActionCreators__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__applyMiddleware__ = __webpack_require__(15);
...
var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.applyMiddleware)(_reduxLogger.logger));

(0, _src.wrapStore)(store, { portName: portName });
...
fetch('./contentScript.js').then(function (res) {
  return res.text();
...
exports.setCurrentTabId = setCurrentTabId;
...
function setCurrentTabId(tabId) {
  return { type: constants.SET_CURRENT_TABID, tabId: tabId };
}

function increment(tabId) {
  return { type: constants.INCREMENT, tabId: tabId };
}

function addTab(tabId) {
  return { type: constants.ADD_TAB, tabId: tabId };
}

function removeTab(tabId) {
  return { type: constants.REMOVE_TAB, tabId: tabId };
}
...
exports.default = function () {
  ...
  switch (action.type) {
    ...
    case constants.ADD_TAB:
      ...
      stateCopy = _extends({}, state);
      var activeTabId = safari.application.activeBrowserWindow.activeTab.id;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(27);
/* global window */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store_Store__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrap_store_wrapStore__ = __webpack_require__(33);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shallowDiff__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__safariTabID__ = __webpack_require__(31);
